...
describe("UI browser validation gate", () => {
  it("runs for main, the operator branch, and prescription feature branches", () => {
  ...
  it("covers keyboard, accessibility, reflow, persisted drafts, and local-draft safety", () => {
  ...
  it("uses synthetic fixture patients, receptions, and draft persistence with no production endpoint", () => {
