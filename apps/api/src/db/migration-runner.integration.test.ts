  ...
  it('applies the history-table migration explicitly and then allows startup check', async () => {
    await withTestSchema(async (pool) => {
      ...
      expect(rows.rows).toEqual([
        ...
        { version: '000007', applied_by: 'vitest' },
        { version: '000008', applied_by: 'vitest' },
        { version: '000009', applied_by: 'vitest' },
        { version: '000010', applied_by: 'vitest' },
        { version: '000011', applied_by: 'vitest' },
        { version: '000012', applied_by: 'vitest' },
        ...
        { version: '000018', applied_by: 'vitest' },
        { version: '000019', applied_by: 'vitest' },
        { version: '000020', applied_by: 'vitest' },
        { version: '000021', applied_by: 'vitest' },
        { version: '000022', applied_by: 'vitest' },
        { version: '000023', applied_by: 'vitest' },
        { version: '000024', applied_by: 'vitest' },
      ]);
    });
  });
