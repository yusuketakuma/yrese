...
source_refs: 構築プロンプト v0.2.0 §11、docs/regulatory/source_registry.md(REG-001)
open_questions:
...
- 入手可否: 公開
- v0.2.0 記載との差異: なし(「令和8年度診療報酬改定」の実在を確認)
...
- v0.2.0 記載との差異: なし(ONS前提という前提どおり)
...
- v0.2.0 記載との差異: なし(「令和8年7月 2.04版以降」と完全一致)
...
- **v0.2.0 記載との差異: なし。※ REG-001/source_registry(f2作成)の「第6.0版が最新」は旧情報 — 第7.0版(令和8年6月)が最新であることを本検証で確定。source_registry 要修正**
...
- **v0.2.0 記載との差異: なし。※ REG-001(f2作成)の「Ver.1.10 が確認済み最新」は旧情報 — Ver.1.11 の存在を公式サイトで確定。source_registry 要修正**
...
- v0.2.0 記載との差異: なし(「許諾取得まで実装凍結・仕様の複製禁止」の方針と整合。用途限定条件も v0.2.0 §29 の記載と一致)
...
- v0.2.0 記載との差異: なし(公式手順への受け渡し方式の妥当性を裏付け)
...
4. 電子処方箋技術解説書 2.04版(令和8年7月)は v0.2.0 指定と完全一致
