...
depends_on: [PRD-007, DOM-001, DOM-002, ADP-001, ADP-002, MOD-006(events)]
...
- Official Adapter 領域(オン資・電子処方箋・オンライン請求・PMH)を FHIR で置換しようとした → BLOCKED_OFFICIAL_ADAPTER_BOUNDARY(境界の詳細は DOM-006 §4)
