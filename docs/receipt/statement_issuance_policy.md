...
source_refs: [構築プロンプト v0.1.8 §0.0.4.5, CAL-003(evidence_register), CLM-001(claim_scope_matrix)]
...
open_questions:
  ...
  - 支払額0円(公費等)の場合の明細書発行要否【要確認: 公式通知 — v0.1.8 明示の要確認事項】
...
- 明細書は処方内容を含むため、領収証よりも高いプライバシー配慮を要する(v0.1.8 §0.0.4.5)。
