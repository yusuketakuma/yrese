...
superseded_by: UIX-001 v0.2.0 §9
...
evidence_ids: []
change_log:
  - 0.1.1 2026-08-26 UIX-001 v0.2.0 §9へ原子的に統合しSUPERSEDED化。本文は履歴/provenanceとして不変
...
- 受入試験の被験者に本番個人情報を使わない(training mode / demo data、v0.2.0 §9.9)。
