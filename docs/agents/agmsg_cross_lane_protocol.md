...
effective_to: null
source_refs:
  - 構築プロンプト v0.1.7 §0.1.6.7〜§0.1.6.10, §0.0.3.9, §0.6
depends_on:
...
共通モジュールに関わるメッセージは以下を追加する(v0.1.7 §0.0.3.9):
...
違反を検知した場合は即時 `AGMSG_PHI_LEAK` として incident ルームへ報告し、該当WPを停止する(v0.1.7 §0.16 停止条件)。
