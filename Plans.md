...
- [~] WP-4226 harden PostgreSQL reception create query row-set authority(MEDIUM-HIGH reception privacy/data integrity/API trust boundary / R2) — VALIDATED / COMMIT_PENDING
