...
- [~] WP-4233 harden PostgreSQL reception-list query row-set authority(MEDIUM reception PHI/data integrity/availability / R2) — FINALIZED / INDEPENDENT_PASS / PUSH_PENDING
