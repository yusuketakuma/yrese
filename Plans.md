...
- [~] WP-0007 外部境界・マスターSSOT(フォーク実行中)
- [~] WP-0008 UI/UX・体験品質SSOT(フォーク実行中)
- [~] WP-0009 セキュリティSSOT(フォーク実行中)
...
- [~] WP-2101a 算定エンジン純粋関数骨格(点数値なし・空ruleset→BLOCKED固定)(codexへWP_ASSIGN)
...
- [ ] WP-4005 CI build対象をworkspace実態に合わせる
...
- [ ] WP-1008 packages/events dead-letter invariant hardening
...
- [ ] WP-1009 concrete error code registry seed
