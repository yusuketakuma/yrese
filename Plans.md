...
- [x] WP-4225 harden reception create command authority parity(MEDIUM-HIGH reception security/privacy/data integrity/API contract / R2) — VALIDATED / COMMIT_PENDING
