...
- [~] WP-1005 packages/trace: calculation_trace / legal_trace / EvidenceRef、evidence必須の強制(codexへWP_ASSIGN済み・CODEX_PLAN承認)
...
- [ ] WP-3004 画面群ルーティングシェル(screen_inventory 仮説に基づく主要業務ルートのプレースホルダー+業務ナビゲーション。API仮定なし)
- [ ] WP-0014 公式資料検証リサーチ(調剤報酬点数表・記録条件仕様・マスター配布元の版/適用日確認 → evidence_id 発行準備。ユーザー許可済みのWeb調査)
