...
1. Add a disposable production-like API/auth environment, then execute the production Web clinical journey, tenant allow/deny and restart checks. Web build/start/static placeholder proof and PostgreSQL-backed CI integration are already recorded.
