...
- **Git boundary:** `origin/main` = `e9ae685`(2026-09-23 ユーザ指示「プッシュしてください」で main を push 済み — WP-7304/7403/7404/7405/7406・起案 3 件・wp-7500 統合を含む)。deploy・環境適用(production/staging)は行わない。
