...
- **Git boundary:** local `main` = `9c0b3579` から fast-forward merge 済み(ユーザ指示 2026-09-16)、さらに `origin/main` へ push 済み(ユーザ指示「pushしてください」)— `origin/main` = `d8844ce`+本record commit。deploy は引き続き行わない。
