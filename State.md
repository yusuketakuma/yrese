...
- **Git boundary:** local `main` = `9c0b3579` から current branch HEAD への fast-forward merge 済み(ユーザ指示 2026-09-16「mainにマージしてください」)。`origin/main` = `c3a082919f4965915fb11671b12db402a157d990` との差分は残る。push / deploy は引き続き行わない。
