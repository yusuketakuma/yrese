...
- **Git boundary:** `origin/main` = `fcc0878`(WP-7302 まで push 済み — 2026-09-19)。local `main` に WP-7403・WP-7304・WP-7404・WP-7405 の実装 commit が順次載る。push は未実施・deploy・環境適用(production/staging)は行わない。
